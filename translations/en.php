...
return [
    ...
    'cc' => 'Country Code',
    'cc_search' => 'For your country code click <a href="https://laendercode.net/de/2-letter-list.html" target="_blank"><span style=color:red>here</span></a><br>',
    ...
    'addButton' => 'Add',
    'deleteButton' => 'Delete',
    'infoText' => 'Entries only appear here if the link to the UserID no longer works!',
    'noFailEntries' => 'No entries with errors',
    'FailEntriesError' => 'ERROR',
